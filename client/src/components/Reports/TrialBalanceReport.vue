                ...
                <div v-for="item in filterNullItems" :key="item.id">
                  <v-row>
                    ...
                    <v-col cols="12" md="3">
                      ...
                      <span v-else-if="!item.sub.sub" class="font-weight-medium x-small">{{ item.account }}:{{item.sub.name}}</span>
                      <span v-else-if="item.sub.sub" class="font-weight-medium x-small">{{ item.account }}:{{item.sub.name}}:{{item.sub.sub}}</span>
                    </v-col>
                    <v-col cols="12" md="2">
