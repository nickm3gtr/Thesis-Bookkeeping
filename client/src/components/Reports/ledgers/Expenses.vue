<template>
  <div class="ledger">
    <p><span class="subtitle-2">Expenses</span></p>
    <div v-for="item in expenses" :key="item.AccountId">
      <v-row class="ml-12">
        <v-col cols="12" md="4">
    ...
    <v-row class="ml-12">
      <v-col cols="12" md="8">
        <span class="subtitle-2">Total Expenses: </span>
      </v-col>
      <v-col cols="12" md="2">
        <p v-if="expenses.length<1"><span></span></p>
