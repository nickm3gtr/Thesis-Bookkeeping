<template>
  <div>
    ...
    <div v-else>
      <div v-if="$store.state.auth.user.account === 'manager'">
        <CustomerComponent />
      </div>
...
import AdminCustomerComponent from '@/components/customers/AdminCustomerComponent'

export default {
  name: 'CustomerPage',
  components: { RestrictedResource, CustomerComponent, AdminCustomerComponent }
}
</script>
