            ...
            <v-card-text>
              <v-flex sm12 md10 offset-md1>
                ...
                <v-row class="ml-4 mb-4">
                  <v-col cols="12" md="5">
                    <span class="x-small font-weight-medium">Gross Profit</span>
                  </v-col>
                  <v-col cols="12" md="3"></v-col>
                  <v-col cols="12" md="3">
                    <p class="text-right right x-small font-weight-medium underlined"><span>&#8369;{{ currency(grossProfit) }}</span></p>
                  </v-col>
                </v-row>
                <v-row class="ml-4 mt-4">
                ...
                <v-row class="ml-4 mb-4">
                  <v-col cols="12" md="5">
                    <span v-if="netProfit < 0" class="font-weight-bold x-small red--text">Net Loss</span>
                    <span v-else class="font-weight-bold x-small">Net Income</span>
                  </v-col>
                  <v-col cols="12" md="3"></v-col>
                  <v-col cols="12" md="3">
                    <p v-if="netProfit < 0"
                      class="text-right right x-small font-weight-bold red--text text--darken-2 underlined"><span>&#8369;{{ currency(formatBalance(netProfit)) }}</span></p>
                    <p v-else class="text-right right x-small font-weight-bold blue--text text--darken- underlined"><span>&#8369;{{ currency(formatBalance(netProfit)) }}</span></p>
                  </v-col>
                </v-row>
              </v-flex>
            </v-card-text>
