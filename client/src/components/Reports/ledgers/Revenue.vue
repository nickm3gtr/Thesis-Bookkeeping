<template>
  <div class="ledger">
    <p><span class="subtitle-2">Revenue</span></p>
    <div v-for="item in revenue" :key="item.AccountId">
      <v-row class="ml-12">
        <v-col cols="12" md="4">
    ...
    <v-row class="ml-12">
      <v-col cols="12" md="8">
        <span class="subtitle-2">Total Revenue: </span>
      </v-col>
      <v-col cols="12" md="2">
        <span v-if="revenue.length<1"></span>
