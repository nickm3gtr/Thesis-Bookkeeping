          ...
          <div :hidden="hidden" id="content" v-if="loading === false">
            <v-card-text>
              ...
              <v-row class="ml-4 mb-4">
                <v-col cols="12" md="5">
                  <div v-if="totalAssets <= 0">
                    <span class="font-weight-bold x-small red--text text--darken-3">
                      Total Assets
                    </span>
                  </div>
                  <div v-else>
                    <span class="font-weight-bold x-small blue--text text--darken-3">
                      Total Assets
                    </span>
                  </div>
                </v-col>
                ...
                <v-col cols="12" md="3">
                  <div v-if="totalAssets <= 0">
                    <p class="text-right x-small right font-weight-bold underlined red--text text--darken-3">
                      <span>&#8369;{{ currency(totalAssets) }}</span>
                    </p>
                  </div>
                  <div v-else>
                    <p class="text-right x-small right font-weight-bold underlined blue--text text--darken-3">
                      <span>&#8369;{{ currency(totalAssets) }}</span>
                    </p>
                  </div>
                </v-col>
              ...
              <v-row class="ml-4 mb-4">
                ...
                <v-col cols="12" md="3">
                  <div v-if="totalLiabilities <= 0">
                    <p class="text-right font-weight-bold x-small right red--text text--darken-3 underlined">
                      <span>&#8369;{{ currency(totalLiabilities) }}</span>
                    </p>
                  </div>
                  <div v-else>
                    <p class="text-right font-weight-bold x-small right blue--text text--darken-3 underlined">
                      <span>&#8369;{{ currency(totalLiabilities) }}</span>
                    </p>
                  </div>
                </v-col>
